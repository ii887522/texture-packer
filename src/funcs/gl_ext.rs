...
pub(crate) fn cfg_gl_attr(video_subsys: &VideoSubsystem) {
...
#[cfg(debug_assertions)]
pub(crate) extern "system" fn on_debug_message(
  source: GLenum,
  type_: GLenum,
  id: GLuint,
  severity: GLenum,
...
pub(crate) fn new_gl_program(vert_shader_code: &[u8], frag_shader_code: &[u8]) -> GLuint {
  unsafe {
...
pub(crate) fn use_default_gl_framebuffer() {
  unsafe {
