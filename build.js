...
options.x86DllOutDirPaths = ['texture-packer/Debug/', 'texture-packer/Release/', 'texture-packer/Test/'],
options.x64DllOutDirPaths = ['texture-packer/x64/Debug/', 'texture-packer/x64/Release/', 'texture-packer/x64/Test/']
...
dependencies(async () => {
  await Promise.all([
    ...
    zip('https://gitlab.com/api/v4/projects/23074770/packages/generic/viewify/1.1.0/viewify-1.1.0.zip', { 'PRIVATE-TOKEN': accessToken })
  ])
